...
HtmlEditorConfig::get('cms')->setOption(
	...
	'button[*],'.
	'fieldset[*],'.
	'a[class|data|id|style|href|target|*],'.
	'i[*],'.
	'span[*],'.
  'img[*],' .
  'h1[*],' .
...
define('SMTPMAILER_SMTP_SERVER_ADDRESS', 'a2plcpnl0781.prod.iad2.secureserver.net'); //SMTP server address
define('SMTPMAILER_DO_AUTHENTICATE', true); //Turn on SMTP server authentication. Set to false for an anonymous connection
define('SMTPMAILER_FROM', 'marcos.peralta@testdisoftpy.com'); //SMTP server username, if SMTPAUTH == true
define('SMTPMAILER_USERNAME', 'marcos.peralta@testdisoftpy.com'); //SMTP server username, if SMTPAUTH == true
define('SMTPMAILER_PASSWORD', 'SFPpy.123'); //SMTP server password, if SMTPAUTH == true
