...
class DataObject extends ViewableData implements DataObjectInterface, i18nEntityProvider {
	...
	public function get_slideNoticias($pos, $cantidad)
	{	
		$index = $pos/$cantidad;
		return $index;
	}

	public function createSlide($pos, $cantidad)
	{	
		$index = $pos%$cantidad;
		return $index == 0 ? true : false ;
	}

	public function modulo($ubicacion, $pos, $cantidad)
	{	
		$index = $pos%$cantidad;
		return $index == $ubicacion ? true : false;
	}
