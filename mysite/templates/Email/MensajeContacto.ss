...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Nuevo Mensaje de Contacto $Mensaje.Nombre - $FechaCreacion</title>
		<style type="text/css">
		...
		body{width:100% !important; min-width:100% !important;} /* Prevent iOS Mail from adding padding to the body */
						...
						*/
						#headerImage{
							...
							/*@editable*/ max-width:700px !important;
							/*@editable*/ width:100% !important;
						}
						/**
						* @tab Mobile Styles
								...
								<table border="0" cellpadding="10" cellspacing="0" width="100%" id="templateHeader">
									<tr>
										<td valign="top" align="center" class="headerContent">
											<h2 style="text-align: center; padding: 10px;">Mensaje de contacto</h2>
										</td>
									</tr>
								</table>
								<!-- // END HEADER -->
						...
						<tr>
							<td align="center" valign="top">
								...
								<table border="0" cellpadding="10" cellspacing="0" width="100%" id="templateBody">
									...
									<tr>
										<td valign="top" class="bodyContent" colspan="4" mc:edit="body_content">
											<br>
