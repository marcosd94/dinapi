...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-11-2019 a las 23:13:39
...
(1, 'Member', '2015-07-21 17:15:08', '2019-11-14 15:03:03', 'Administrador por defecto', NULL, 'admin', '80ab383fd070985db71d5b2129d77410dc0e83c9', '2019-11-17 15:03:03', '$2y$10$684be06a41ff4d4fcdbc9Oz0X.H0r/czaafPEU5AYG6rvCBylBCbK', '$2y$10$684be06a41ff4d4fcdbc9OQ3zMuHpYVZCkwbu1wtJP/LVImzHEgay', 437, '2019-11-14 19:13:36', NULL, NULL, 'blowfish', '10$684be06a41ff4d4fcdbc9c', NULL, NULL, 'es_ES', 0, 'dd/MM/yyyy', 'HH:mm:ss'),
...
(4, 'Noticia', '2019-11-13 19:39:26', '2019-11-13 19:39:26', 'Magistral exposición de Expertos de la Ompi, acerca del Sistema Internacional de Patentes', 1, '2019-11-09', 0, '<div style="text-align: justify;">La Asociación Interamericana de la Propiedad Intelectual (ASIPI), en conjunto con la Organización Mundial de Propiedad Intelectual (OMPI) y la Dirección Nacional de Propiedad Intelectual (DINAPI), realizaron el Taller itinerante sobre el sistema internacional de patentes: PCT y EPCT, con la participación de expertos nacionales e internacionales que hablaron sobre la evolución de las legislaciones que la amparan y la importancia de ellas para el desarrollo económico de los países. </div>\n<div style="text-align: justify;"></div>\n<div style="text-align: justify;">El Dr. Joel Talavera, director nacional de la DINAPI, señaló que el tratado de cooperación en materia de patentes es una realidad en la mayoría de los países que forman parte de la OMPI, por lo que este tipo de talleres ayudan a adquirir mayor conocimiento acerca de su uso, así como la experiencia de otros países en lo que a su implementación respecta. </div>\n<div style="text-align: justify;">Agregó que desde el inicio de su administración al frente de la institución, se han hecho trabajos de fortalecimiento del área, mediante el aumento de examinadores que han tenido mora cero en lo que respecta a los exámenes de forma, con lo que, en un año, se han concedido 26 patentes.  </div>\n<div style="text-align: justify;"></div>\n<div style="text-align: justify;">Fabrizio Módica, representante de ASIPI, indicó que es preciso conocer las reglas del PCT y EPCT para que investigadores paraguayos analicen la posibilidad de, incluso, patentar en países del extranjero.</div>\n<div style="text-align: justify;"></div>\n<div style="text-align: justify;">El Sr. Carlos Roy Mayoral, representante de la OMPI, indicó que «el sistema de patentes puede desempeñar un papel importante en la promoción del comercio, la transferencia de tecnología y la innovación y creatividad, tanto en el ámbito local como el internacional». Explicó que la OMPI participa activamente en la búsqueda de soluciones para abordar adecuadamente los desafíos mundiales y agradeció a Paraguay por formar parte de esta serie de talleres sobre el tema. </div>\n<div style="text-align: justify;"></div>\n<div style="text-align: justify;">El taller itinerante sobre el sistema internacional de patentes se realizará también en Sao Paulo y en Río de Janeiro, Brasil, el 6 y el 8 de noviembre respectivamente.</div>', 879, 346);
